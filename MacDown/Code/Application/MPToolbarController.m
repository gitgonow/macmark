...
- (NSArray<NSString *> *)toolbarDefaultItemIdentifiers:(NSToolbar *)toolbar
{
    ...
    int spaceAfterCount = 0; // empty array
    int flexibleSpaceAfterCount = (int)(sizeof(flexibleSpaceAfterIndices) / sizeof(flexibleSpaceAfterIndices[0]));
    int i = 0;
    int j = 0;
    int k = 0;
    (void)spaceAfterIndices; // suppress unused warning
